  ...
  if (!analysis) {
    return (
      <section className="panel" id="sec8">
        ...
        >
          <div>
            <div style={{ fontSize: 18, fontWeight: 700 }}>利確と損切りの見直し（TP/SL評価）</div>
    ...
    <section className="panel" id="sec8">
      ...
      <div style={{ padding: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, marginBottom: 20, minWidth: 0 }}>
          <div>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 12 }}>現在のR:R比</div>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 12 }}>推奨R:R比</div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 8 }}>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 12 }}>到達率</div>
        ...
        <div className="panel" style={{ padding: 16, background: 'var(--chip)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>改善提案</div>
