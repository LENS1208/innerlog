  ...
  if (!timingMetrics) {
    return (
      <section className="panel" id="sec5">
        ...
        >
          <div>
            <div style={{ fontSize: 18, fontWeight: 700 }}>タイミングの質（エントリー/エグジット）</div>
    ...
    <section className="panel" id="sec5">
      ...
      <div style={{ padding: 16 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, marginBottom: 20, minWidth: 0 }}>
          ...
          <div className="panel" style={{ padding: 16 }}>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>MAE（最大含み損）</div>
          ...
          <div className="panel" style={{ padding: 16 }}>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>MFE活用率</div>
          ...
          <div className="panel" style={{ padding: 16 }}>
            <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>早期利確率</div>
        ...
        <div className="panel" style={{ padding: 16, background: 'var(--chip)' }}>
          <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>評価コメント</div>
