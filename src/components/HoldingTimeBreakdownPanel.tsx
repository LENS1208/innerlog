  ...
  const pnlDistributionData = useMemo(() => {
    ...
    return {
      ...
      datasets: [{
        label: '損益',
        data: [...losses, ...wins],
        backgroundColor: [...losses.map(() => 'rgba(239, 68, 68, 0.8)'), ...wins.map(() => 'rgba(22, 163, 74, 0.8)')],
      }],
    };
  }, [stats.pnlBuckets]);
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '24px' }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h3 style={{ fontSize: 13, fontWeight: 'bold', color: 'var(--muted)', marginBottom: 16 }}>
              時間帯別（日本時間）
            </h3>
          ...
          <section style={{ marginBottom: 32 }}>
            <h3 style={{ fontSize: 13, fontWeight: 'bold', color: 'var(--muted)', marginBottom: 16 }}>損益分布</h3>
            <div style={{ height: 300 }}>
              <Bar
