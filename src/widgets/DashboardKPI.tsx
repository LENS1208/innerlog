  ...
  return (
    <div className="kpi-grid" style={{ marginBottom: 12 }}>
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>総損益</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>総獲得pips</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>平均損益</div>
        <div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>勝率</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>プロフィットファクター</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>最大ドローダウン</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>期待値（円）</div>
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>期待値（pips）</div>
        <div className="kpi-value">
      ...
      <div className="kpi-card">
        <div className="kpi-title" style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 15, fontWeight: 'normal', color: 'var(--muted)', margin: '0 0 8px' }}>平均保有時間</div>
