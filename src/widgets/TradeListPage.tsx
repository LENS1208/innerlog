        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              background: currentPage === 1 ? "var(--muted-bg)" : "var(--button-bg)",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: "1px solid var(--line)",
                  borderRadius: 6,
                  background: currentPage === pageNum ? "var(--accent)" : "var(--button-bg)",
          ...
          <button
            ...
            style={{
              ...
              border: "1px solid var(--line)",
              borderRadius: 6,
              background: currentPage === totalPages ? "var(--muted-bg)" : "var(--button-bg)",
