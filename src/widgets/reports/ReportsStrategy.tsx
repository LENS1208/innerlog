    ...
    <div style={{ width: "100%" }}>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ Top</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ Bottom</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>方向比較</h3>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ別（上位6）</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>方向別（買い・売り）</h3>
          <div style={{ height: 180 }}>
            <Doughnut
              data={{
                labels: ["買い", "売り"],
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ別 平均保有時間</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
                labels: setupData.slice(0, 6).map((s) => s.setup),
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ別 勝率</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
                labels: setupData.slice(0, 6).map((s) => s.setup),
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セットアップ別 PF</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
                labels: setupData.slice(0, 6).map((s) => s.setup),
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>方向×セットアップ（クロス）</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
        <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>戦略・行動 明細</h3>
