    ...
    <div style={{ width: "100%" }}>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>曜日 Top</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>曜日 Bottom</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>時間帯 Top</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>時間帯 Bottom</h3>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>曜日別</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>時間帯別</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
                labels: hourData.map((h) => h.label),
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>日別推移</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>週別推移</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>保有時間分布</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>日別勝率</h3>
          <div style={{ height: 180 }}>
            <Line
              data={{
                labels: dailyData.map(([date]) => date.substring(5)),
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>散布図：時刻×損益</h3>
          <div style={{ height: 180 }}>
            <Scatter
              data={{
                datasets: [
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>散布図：保有時間×損益</h3>
          <div style={{ height: 180 }}>
            <Scatter
              data={{
                datasets: [
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>連敗ヒート（時間帯）</h3>
          <div
            style={{
              height: 180,
              display: "flex",
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
        <h3 style={{ margin: "0 0 8px 0", fontSize: 15, color: "var(--muted)" }}>セグメント別明細</h3>
