    ...
    <div style={{ width: "100%" }}>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>通貨ペア Top</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>通貨ペア Bottom</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>価格帯 Top</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>主要通貨 vs クロス</h3>
      ...
      >
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>通貨ペア別（上位6）</h3>
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>価格帯（pipsビン）</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>通貨（ベース/クオート別）</h3>
          <div style={{ height: 180 }}>
            <Bar
              data={{
      ...
      >
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
          <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>相場状態（β）</h3>
          <div
            style={{
              height: 180,
              display: "flex",
      ...
      <div style={{ background: "var(--surface)", border: "1px solid var(--line)", borderRadius: 16, padding: 12 }}>
        <h3 style={{ margin: "0 0 8px 0", fontSize: 15, fontWeight: "normal", color: "var(--muted)" }}>市場・銘柄 明細</h3>
