  ...
  return (
    <div className="dash-row-3">
      <div className="dash-card">
        <h3 style={{ margin: '0 0 8px', fontSize: 15, fontWeight: 'normal', color: 'var(--muted)' }}>曜日別</h3>
        <WeekdayChart trades={trades} />
      </div>
      <div className="dash-card">
        <h3 style={{ margin: '0 0 8px', fontSize: 15, fontWeight: 'normal', color: 'var(--muted)' }}>時間帯別</h3>
        <TimeOfDayChart trades={trades} />
      </div>
      <div className="dash-card">
        <h3 style={{ margin: '0 0 8px', fontSize: 15, fontWeight: 'normal', color: 'var(--muted)' }}>通貨ペア別</h3>
...
export function SetupChart() {
  return (
    <div className="dash-card">
      <h3 style={{ margin: '0 0 8px', fontSize: 15, fontWeight: 'normal', color: 'var(--muted)' }}>セットアップ別（タグ）</h3>
