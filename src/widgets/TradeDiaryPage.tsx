      ...
      <section className="td-card compact td-trade-info" id="tradeInfoCard" style={{ marginTop: 16 }}>
        ...
        <div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', gap: 16, marginBottom: 12 }}>
            ...
            <div style={{ color: 'var(--muted)', fontSize: 13, fontWeight: 500 }}>指値/逆指値</div>
            <div style={{ color: 'var(--muted)', fontSize: 13, fontWeight: 500 }}>エントリー時刻</div>
            <div style={{ color: 'var(--muted)', fontSize: 13, fontWeight: 500 }}>エントリー価格</div>
