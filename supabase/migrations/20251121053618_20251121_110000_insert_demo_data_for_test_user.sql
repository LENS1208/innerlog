/*
  ...
  1. 目的
    - テストユーザー（kan.yamaji@gmail.com）用のデモトレードデータを挿入
    - 3つのデータセット（A, B, C）を作成
    - 実際の取引パターンを反映
...
BEGIN
  ...
  -- アカウントサマリーデータを挿入
  INSERT INTO account_summary (user_id, balance, equity, profit, deposit, withdraw, commission, swap, swap_long, swap_short)
  VALUES (test_user_id, 1221500, 1221500, 1221500, 1000000, 0, -540, 90, 45, 45)
  ...
  -- アカウント取引履歴を挿入
  DELETE FROM account_transactions WHERE user_id = test_user_id;
  
  INSERT INTO account_transactions (user_id, time, type, amount, balance, comment, swap_long, swap_short) VALUES
  (test_user_id, '2025-01-01 00:00:00+00', 'deposit', 1000000, 1000000, '初期入金', 0, 0),
  (test_user_id, '2025-01-31 23:59:59+00', 'credit', 652000, 1652000, '1月の利益', 15, 10),
  (test_user_id, '2025-02-28 23:59:59+00', 'credit', 395500, 2047500, '2月の利益', 20, 18),
  (test_user_id, '2025-03-31 23:59:59+00', 'credit', 174000, 2221500, '3月の利益', 10, 17);
